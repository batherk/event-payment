...
class EventPassAdmin(admin.ModelAdmin):
    fields = ("name", "description","role","price","event", "total_spots", "remaining_spots")
    list_display = ("name","role","price","event", "total_spots", "remaining_spots")
    list_filter = ("event",("role",EnumListFilter),)
    readonly_fields = ("remaining_spots",)
    raw_id_fields = ("event",)